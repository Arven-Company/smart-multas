/* Smart Multas — efeitos visuais (ports vanilla de Dia Text Reveal, Highlighter e Animated Beam do MagicUI) */
(function () {
  'use strict';
  ...
  /* ============================================================
     1. DIA TEXT REVEAL — faixa de gradiente varre o texto e
        assenta na cor padrão. Cores da marca (sky/azul/verde).
     ============================================================ */
  var DIA_COLORS = ['#38BDF8', '#2563EB', '#10B981', '#34D399'];
  var BAND_HALF = 17;
  ...
  /* ============================================================
     3. ANIMATED BEAM — feixes de luz Foto/Código → IA Smart
        Multas → Teses/Petição/Protocolo.
     ============================================================ */
  ...
  var nodes = {
    photo: integ.querySelector('.dot-photo'),
    code: integ.querySelector('.dot-code'),
    core: integ.querySelector('.dot-core'),
    out: integ.querySelectorAll('.integ-out .integ-dot')
  };

  var beamDefs = [
    { from: 'photo', to: 'core', curve: -0.18, delay: 0 },
    { from: 'code', to: 'core', curve: 0.18, delay: 1.1 },
  ...
  function buildBeams() {
    ...
    beamDefs.forEach(function (def, i) {
      ...
      base.setAttribute('stroke', '#B4BFCF');
      ...
      [['0%', '#38BDF8', '0'], ['25%', '#38BDF8', '1'], ['65%', '#2563EB', '1'], ['100%', '#10B981', '0']].forEach(function (s) {
